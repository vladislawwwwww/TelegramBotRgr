...
def home_screen(message):
    if message.text == 'Диаграмма BPMN':
        ...
        button13 = types.InlineKeyboardButton('команда 1', callback_data='order_function1')
        button14 = types.InlineKeyboardButton('команда 2', callback_data='order_function2')
        order_markup.add(button13, button14)
        bot.send_message(message.chat.id, 'Выберите действие:', reply_markup=order_markup)
    else:
...
def callback_handler(call):
    if call.data == 'bpmn':
        ...
        button10 = types.InlineKeyboardButton('Ссылка на диаграмму', callback_data='bpmn_function2')
        bpmn_markup.add(button9, button10)
        bot.send_message(call.message.chat.id, 'Выберите действие:', reply_markup=bpmn_markup)
        ...
        button14 = types.InlineKeyboardButton('команда 2', callback_data='order_function2')
        order_markup.add(button13, button14)
        bot.send_message(call.message.chat.id, 'Выберите действие:', reply_markup=order_markup)
        ...
        button16 = types.InlineKeyboardButton('Контакты поддержки', callback_data='help_function2')
        help_markup.add(button15, button16)
        bot.send_message(call.message.chat.id, 'Выберите действие:', reply_markup=help_markup)
