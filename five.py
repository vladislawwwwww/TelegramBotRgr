...
def enter_destination(message, order):
    ...
    # Здесь вы можете сохранить заказ в базе данных или выполнить другие необходимые действия
    # Например: save_order_to_database(order)
    # отчет
